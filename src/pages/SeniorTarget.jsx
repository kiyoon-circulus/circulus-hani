...
function SeniorTarget() {
  ...
  const handleConfirm = () => {
    setOpen(false);
    navigate(
      `/senior/learn/${character}/${selected.chapterId}?target=${selected.name}`
    );
  };
  ...
  return (
    <>
      <div className="grid grid-rows-[auto_auto_1fr] overflow-hidden md:gap-4 w-screen h-screen">
